# リサーチエージェント · Energy & Power Engineering

[简体中文](README.md) | [English](README.en.md) | **日本語** | [Español](README.es.md) | [Deutsch](README.de.md)
...
- コマンドラインに慣れており、自身の Anthropic API キーを持ち、原稿やデータを Web ツールに貼りたくない人

> 不向きな人：GUI が必要な方、Anthropic API キーをお持ちでない方、API の費用をツール側に負担させたい方。
...
Python 3.11+ と [Anthropic API キー](https://console.anthropic.com) が必要です。
...
# .env を編集：
#   ANTHROPIC_API_KEY=sk-ant-...        （必須、https://console.anthropic.com）
